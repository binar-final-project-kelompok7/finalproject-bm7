          ...
          <div className="modal-content">
            ...
            <div className="modal-body" style={{ fontSize: "12px", paddingLeft: "200px", color: "#000", fontWeight: "600" }}>
              ...
              <div className="mb-1">
                ...
                <input type="text" className="form-control" id="category" value={courseData.category} onChange={handleChange} placeholder="Text" style={{ width: "80%", height: "50px", borderRadius: "15px" }} />
              </div>
              <div className="mb-1">
              ...
              <div className="mb-1">
                ...
                <input type="text" className="form-control" id="type" value={courseData.type} onChange={handleChange} placeholder="Text" style={{ width: "80%", height: "50px", borderRadius: "15px" }} />
              </div>
              <div className="mb-1">
                <label htmlFor="level" className="form-label">
                  Level
                </label>
                <input type="text" className="form-control" id="level" value={courseData.level} onChange={handleChange} placeholder="Text" style={{ width: "80%", height: "50px", borderRadius: "15px" }} />
              </div>
              <div className="mb-1">

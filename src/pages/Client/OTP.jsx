    ...
    return (
      <>
        {buttonProps.remainingTime !== 0 ? (
          ...
          <button className="text-danger border-0" {...buttonProps}>
            Kirim Ulang
          </button>
        )}
      </>
          ...
          <form id="form" className="d-flex flex-column">
            ...
            <div className="frame mb-5 d-flex flex-column align-items-center">
              ...
              <div className="d-flex">
                <ResendOTP className="text-otp d-flex" maxTime={60} onResendClick={() => console.log("Resend clicked")} renderButton={renderButton} renderTime={renderTime} />
              </div>
            </div>
            <button className="rounded-3 border-0 p-2 text-white mb-4 w-100" style={{ backgroundColor: "#6148ff" }} type="button" onClick={{}}>
              Simpan
            </button>
          </form>
        </div>

  ...
  return (
    <div className='containerNavAdmin d-flex flex-column w-25 bg-primary text-center' style={{height: '100vh'}}>
        ...
        <nav className='d-flex flex-column'>
            <NavLink className="py-2 bg-primary text-white text-decoration-none" to="/dashboard-admin/payment-status">Dashboard</NavLink>
            <NavLink className="py-2 bg-primary text-white text-decoration-none" to="/dashboard-admin/manage-class">Kelola Kelas</NavLink>

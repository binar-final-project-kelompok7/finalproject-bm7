  ...
  return (
    <>
      <div className="dekstop">
            ...
            <div className="Materi-card" style={{ position: "absolute", backgroundColor: "#fff", boxShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)", marginTop: "-200px", paddingTop: "20px", borderRadius: "20px", paddingRight: "50px" }}>
              ...
              <div className="chapter1">
                ...
                <ul>
                  ...
                  <hr></hr>
                  <li class="" data-bs-toggle="modal" href="#exampleModalToggle" role="button" style={{ display: "flex", alignItems: "center", cursor: "pointer" }} id="premium" onClick={togglePopup}>
        ...
        <div className="section2" style={{ paddingTop: "50px", paddingLeft: "100px" }}>
          <div
            ...
            role="button"
            onClick={togglePopup}
            style={{ backgroundColor: "#000000D9", width: "55%", height: "370px", borderRadius: "20px", display: "flex", justifyContent: "center" }}
          >
            <img src="./img/play-video.png" style={{ width: "15%", height: "120px", marginTop: "110px" }}></img>
          </div>
      ...
      <div className="mobile">
        ...
        <div className="video" style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
          <img src="./img/play-video.png" style={{ paddingTop: "40px", paddingBottom: "40px" }} class="" data-bs-toggle="modal" href="#exampleModalToggle" role="button" onClick={togglePopup}></img>
        </div>
          ...
          <div className="classmateri">
            <div className="chapter1">
              ...
              <ul>
                ...
                <hr></hr>
                <li class="" data-bs-toggle="modal" href="#exampleModalToggle" role="button" style={{ display: "flex", alignItems: "center", marginLeft: "-20px" }} id="premium" onClick={togglePopup}>
                  <img src="./img/circle/Circle3.png" alt="Circle" style={{ marginRight: "10px" }} />
                  <h7 style={{ width: "78%", fontSize: "15px" }}>Pengenalan Design System</h7>
                  <img src="./img/Fill-2.png" alt="Fill" />
                </li>

...
const NavigasiAkun = ({ onTabChange }) => {
  ...
  return (
    <div className="d-flex flex-row flex-md-column w-50 text-start ps-5 pt-4 gap-4">
      <NavLink
        to="/account-settings/edit-profile/:username"
        className={({ isActive }) =>
          !isActive
            ? "notActive text-decoration-none d-flex align-items-md-center align-items-start text-black"
            : "active text-decoration-none d-flex align-items-md-center align-items-start"
        }
      >
